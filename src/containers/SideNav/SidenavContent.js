                        ...
                        <ul className="sub-menu">
                            <li>
                                <NavLink className="prepend-icon" 
                                    to="/app/profile/profileSetting" >
                                    <span className="nav-text"><IntlMessages id="sidebar.profile.setting"/></span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink className="prepend-icon"
                                         to="/app/profile/profileDetails">
                                <span className="nav-text text-transform-none"><IntlMessages
                                    id="sidebar.profile.profileDetail"/></span>
                                </NavLink>
                            </li>
                        </ul>
                    </li>
